...
/**
 * This component handles the paging buttons and paging functionality of a horizontally scrollable items list
 */
export class FefScrollPager {
    ...
    initButtons() {
        if(this.$innerContainer[0].scrollWidth > this.$innerContainer.innerWidth() + RIGHT_OFFSET) {
